    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (i = 0; i < x.length; i++) {
          ...
          output += "<tr><td>" + x[i].name + "</td><td>" + x[i].address + "</td><td>" + x[i].block_name + "</td><td>" + x[i].district_name + "</td><td>" + x[i].date + "</td><td>" + x[i].from + "</td><td>" + x[i].to + "</td><td> ₹ " + x[i].fee + "</td><td class='vabl teal accent-3' >" + x[i].available_capacity + "</td><td>" + x[i].available_capacity_dose1 + "</td><td>" + x[i].available_capacity_dose2 + "</td><td class='red-text'>" + x[i].min_age_limit + "+</td><td>" + x[i].vaccine + "</td> </tr>"
        }
